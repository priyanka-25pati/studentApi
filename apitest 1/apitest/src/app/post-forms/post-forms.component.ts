...
export class PostFormsComponent {
  ...
  postData() {
    ...
    this.dataService.postDataStudent(userData.username, userData.avatar, userData.email,userData.subject1,userData.subject2,userData.subject3,userData.subject4,userData.subject5).subscribe({
